...
<body>
  ...
  <div class="left-content">
    ...
    <!-- header-starts -->
      ...
      <div class="col-sm-12">
        <div class="my-auto"><h1>Data Quality Control <a id="myBtn" class="btn btn-success" role="button"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Tambah</a></h1> 
          <br>
          ...
          <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                ...
                                <div style="margin-top: 25px; margin-left: 300px; width: 70%" class="modal-content">
                                    <div class="modal-header" style="background-color: #b80020">
                                        ...
                                        <h2>Quality Control <i class="glyphicon glyphicon-tasks"></i></h2>
                                    </div>
                                    <div class="modal-body">
                                        <div style="margin-top: 10px" class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                        <div class="table-responsive">
                                        <?php echo form_open_multipart('QualityControl/add'); ?>
                                        <?php if (validation_errors()) {
                                                   ?><div style="margin-top: 20px" class="alert alert-danger">
                                                    <strong><?php echo validation_errors(); ?></strong></div><?php } 
                                        ...
                                        <div style="margin-top: " class="form-group">
                                            ...
                                            <input class="form-control" id="kualitasBarang" type="text" name="kualitasBarang" value="<?php echo set_value('kualitasBarang') ?>" placeholder="Kualitas Produk">
                                        </div>
          ...
          <table class="table table-bordered table-hover" style="float: right;" id="example">
            <thead>
                <tr>
                    ...
                    <th width="10%">Kualitas Produk</th>
                    <th width="18%">Action</th>
                </tr>
            </thead>
            <tbody><?php foreach ($data_kualitas as $key) { ?>
                <tr>
                    
                    <td><?php echo $key->kualitasBarang; ?></td>
                    <td><a href="<?php echo site_url('QualityControl/edit/').$key->idKualitas ?>" type="button" class="btn btn-success"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span>Edit</a> | <a href="<?php echo site_url('QualityControl/delete/').$key->idKualitas ?>" type="button" class="btn btn-danger" onClick="JavaScript: return confirm('Anda yakin Hapus data ini ?')"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span>Hapus</a></td>
