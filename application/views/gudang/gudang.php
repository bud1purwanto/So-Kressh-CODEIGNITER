...
<body>
  ...
  <div class="left-content">
    ...
    <!-- header-starts -->
      ...
      <div class="col-sm-12">
        <div class="my-auto"><h1>Data Gudang Bahan Jadi <a id="myBtn" class="btn btn-success" role="button"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Tambah</a></h1> 
          <br>
          ...
          <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                ...
                                <div style="margin-top: 25px; margin-left: 300px; width: 70%" class="modal-content">
                                    <div class="modal-header" style="background-color: #b80020">
                                        ...
                                        <h2>Gudang Bahan Jadi <i class="glyphicon glyphicon-tasks"></i></h2>
                                    </div>
                                    <div class="modal-body">
                                        <div style="margin-top: 10px" class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                        <div class="table-responsive">
                                        <?php echo form_open_multipart('gudang/add'); ?>
                                        <?php if (validation_errors()) {
                                                   ?><div style="margin-top: 20px" class="alert alert-danger">
                                                    <strong><?php echo validation_errors(); ?></strong></div><?php } 
                                        ...
                                        <div style="margin-top: " class="form-group">
                                            ...
                                            <input class="form-control" id="namaProduk" type="text" name="namaProduk" value="<?php echo set_value('namaProduk') ?>" placeholder="Nama Produk">
                                        </div>
                                        ...
                                        <!-- <div style="margin-top: " class="form-group">
                                            ...
                                            <select class="form-control" id="required" name='idProduksi' data-placeholder="iD Produksi">
                                            <?php foreach ($produksi as $key) { ?>
                                                 <?php echo "<option value='".$key->idProduksi."'>".$key->namaBarang."</option>" ?>
                                            <?php } ?>
                                            </select>
                                        </div> -->
                           <div style="margin-top: " class="form-group">
                                            <label>ID Kualitas</label>
                                            <select class="form-control" id="required" name='idKualitas' data-placeholder="iD Produksi">
          ...
          <table class="table table-bordered table-hover" style="float: right;" id="example">
            ...
            <tbody><?php foreach ($data_gudang as $key) { ?>
                <tr>
                    ...
                    <td><a href="<?php echo site_url('gudang/edit/').$key->idGudangBahanJadi ?>" type="button" class="btn btn-success"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span>Edit</a> | <a href="<?php echo site_url('gudang/delete/').$key->idGudangBahanJadi ?>" type="button" class="btn btn-danger" onClick="JavaScript: return confirm('Anda yakin Hapus data ini ?')"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span>Hapus</a></td>
