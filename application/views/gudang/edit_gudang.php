...
<body>
  ...
  <div class="left-content">
    ...
    <!-- header-starts -->
      ...
      <div class="col-sm-12">
        <div class="my-auto"><h1>Edit Data Gudang</h1> 
          <br>
         ...
         <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
               <div class="panel panel-default">
                        <?php foreach ($get_gudang as $key) {
                        ?>
                        <div class="panel-body">
                <?php echo form_open_multipart('gudang/edit/'.$this->uri->segment(3)); ?>
                    <?php if (validation_errors()) {
                        ...
                        <div class="table-responsive">
                            ...
                            <div style="margin-top: 0px" class="form-group">
                                ...
                                <input class="form-control" id="idGudangBahanJadi" name="idGudangBahanJadi" type="text" placeholder="ID Gudang" value="<?php echo $key->idGudangBahanJadi; ?>">
                            </div>
                            <div style="margin-top: 0px" class="form-group">
                                <label>Nama Produk</label>
                                <input class="form-control" id="namaProduk" name="namaProduk" type="text" placeholder="Nama Produk" value="<?php echo $key->namaProduk; ?>">
                            </div>
                            <div style="margin-top: 0px" class="form-group">
                                <label>Jumlah</label>
                           ...
                           <!-- <div style="margin-top: " class="form-group">
                                            ...
                                            <?php foreach ($produksi as $key) { ?>
                                                 <?php echo "<option value='".$key->idProduksi."'>".$key->idProduksi."</option>" ?>
                                            <?php } ?>
                                            </select>
                           </div> -->
                           </div> -->
