...
<body>
  ...
  <div class="left-content">
    ...
    <!-- header-starts -->
      ...
      <div class="col-sm-12">
        <div class="my-auto"><h1>Bagian Produksi <a id="myBtn" class="btn btn-success" role="button"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Tambah</a></h1> 
          <br>
                                ...
                                <div style="margin-top: 25px; margin-left: 300px; width: 70%" class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div style="margin-top: " class="form-group">
                                            ...
                                            <input class="form-control" id="namaBarang" type="text" name="namaBarang" value="<?php echo set_value('namabarang') ?>" placeholder="Nama Barang">
                                        </div>
                                        ...
                                        <div style="margin-top: " class="form-group">
                                            ...
                                            <select class="form-control" id="required" name='idPengadaan' data-placeholder="Pilih Pengarang">
                                            <?php foreach ($namaBarang as $key) { ?>
                                                 <?php echo "<option value='".$key->idPengadaan."'>".$key->namaBahan."</option>" ?>
                                            <?php } ?>
                                            </select>
                                        </div>
          ...
          <table class="table table-bordered table-hover" style="float: right;" id="example">
            ...
            <tbody><?php foreach ($data_produksi as $key) { ?>
                <tr>
                    ...
                    <td><a href="<?php echo site_url('produksi/edit/').$key->idProduksi ?>" type="button" class="btn btn-success"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span>Edit</a> | <a href="<?php echo site_url('produksi/delete/').$key->idProduksi ?>" type="button" class="btn btn-danger" onClick="JavaScript: return confirm('Anda yakin Hapus data ini ?')"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span>Hapus</a></td>
